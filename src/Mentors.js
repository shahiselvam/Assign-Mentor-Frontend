                                                        ...
                                                        return (
                                                            <tr key={mentors._id}>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <i class="fa fa-pencil-square-o" aria-hidden="true" onClick={() => this.editMentor(mentors)}></i>

                                                                </td>
                                                                <td>

                                                                    <i class="fa fa-trash" aria-hidden="true" onClick={() => this.deleteMentor(mentors._id)}></i>
